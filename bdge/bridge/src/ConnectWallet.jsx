...
function ConnectWallet(props) {
    ...
    useEffect(() => {
        if (localStorage.getItem("accounts") != null && localStorage.getItem("accounts") != undefined && localStorage.getItem("Accounts") != null && localStorage.getItem("Accounts") != undefined) {
            ...
            setChainID(async () => await web3.eth.getChainId())
        }
    }, [])
    ...
    useEffect(() => {
        ...
        props.changeChainCallback(chainID, new web3.eth.Contract(props.contractABI, props.contractAddress))
    }, [theAccount])

    useEffect(() => {
        setChainID(async () => await web3.eth.getChainId())
        props.changeChainCallback(chainID, new web3.eth.Contract(props.contractABI, props.contractAddress))
    }, [buttonStyle, theAccount])
...
ConnectWallet.propTypes = {
    ...
    changeChainCallback: PropTypes.func
}
